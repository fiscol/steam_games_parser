...
#開啟 Google Sheet 資料表
spreadsheet_key = '1bdmBT2Taq0JZjs5qn4acuihJWLK5blwsS4vlgOEf3s0'
#取得目前工作分頁的長度
...
# 搜尋 URL
steam_url = 'https://steam250.com/hidden_gems'
...
if r.status_code == requests.codes.ok:
  ...
  score_tag = rank_div.find_all("span", class_="score")
  ...
  while(k < len(img_tag)):
    ...
    k += 1
  r = 0
  while(r < len(score_tag)):
    main_array[r][2] = float(score_tag[r].text)
    r += 1
  print(main_array)
